...
import org.activiti.bpmn.converter.alfresco.AlfrescoFormPropertiesTaskXMLConverter;
...
public class BpmnXMLConverter implements BpmnXMLConstants {
    ...
    static {
        ...
        addConverter(new FormPropertiesTaskXMLConverter());
        ...
        addConverter(new AlfrescoFormPropertiesTaskXMLConverter());
    }
    ...
    public BpmnModel convertToBpmnModel(XMLStreamReader xtr) {
        ...
        model.setFormPropertiesTaskFormTypes(formPropertiesTaskFormTypes);
        try {
