...
public class TestActivityBehaviorFactory extends AbstractBehaviorFactory implements ActivityBehaviorFactory {
	...
	@Override
	public FormPropertiesTaskActivityBehavior createFormPropertiesTaskActivityBehavior(FormPropertiesTask formPropertiesTask, TaskDefinition taskDefinition) {
		return wrappedActivityBehaviorFactory.createFormPropertiesTaskActivityBehavior(formPropertiesTask, taskDefinition);
	}
