...
public interface ActivityBehaviorFactory {
  ...
  public abstract FormPropertiesTaskActivityBehavior createFormPropertiesTaskActivityBehavior(FormPropertiesTask formPropertiesTask, TaskDefinition taskDefinition);
