 ...
 */
public class FormPropertiesTaskCompleteTransformer extends Activiti2SimulationEventFunction {
    ...
    public FormPropertiesTaskCompleteTransformer(String simulationEventType) {
